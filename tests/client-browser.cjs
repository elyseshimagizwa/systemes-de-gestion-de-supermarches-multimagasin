...
(async () => {
 ...
 await sleep(3500);
 await check('Confirmation commande apres redirection',`location.pathname.endsWith('/index.php') && document.body.innerText.includes('enregistrée.') && document.getElementById('cart-count').textContent==='0'`);
